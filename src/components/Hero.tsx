...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-white to-pale-green-50 dark:from-slate-900 dark:to-slate-800 overflow-hidden py-24"
    >
      <div
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <GlassCard
            className="p-5 sm:p-8 mb-8 bg-white/30 dark:bg-slate-800/30 backdrop-blur-sm border border-medium-spring-green-200 dark:border-medium-spring-green-500/30"
            blur="8px"
          >
            <motion.h1
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-800 dark:text-white tracking-tight mb-4 break-words"
            ...
            <motion.p
              className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto"
              variants={itemVariants}
            >
              I build scalable web and mobile applications from scratch using React,
              React Native, Node.js, and cloud deployment tools.
            </motion.p>
